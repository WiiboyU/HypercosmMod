...
namespace HypercosmMod.NPCs.Rhenzium
{
    ...
    public class BigLipsGhost : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Rhenzium Drone");
        }
		...
		public override void HitEffect(int hitDirection, double damage) 
		{
			...
			else
			{
				...
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/BigLipsGhostGore"), 1f);
			}
}
        ...
        public override void AI()
        {
            ...
            if (npc.ai[1] >= 180)
            {
                ...
                int damage = 20;
                int type = mod.ProjectileType("RhenziumShrapnelHostile");
		...
		public override void NPCLoot()
        {
			...
			{
			Item.NewItem(npc.getRect(), mod.ItemType("BabyDrone"));
			}
			if (Main.rand.NextBool(25)) 
			{
			Item.NewItem(npc.getRect(), mod.ItemType("PaleBlaster"), Main.rand.Next(1, 1));
                        } 
			if (Main.rand.NextBool(2)) 
			{
